-- Full Airsoft database bootstrap (run on an empty or existing Supabase project)
-- This file consolidates all current migrations into one idempotent setup.
